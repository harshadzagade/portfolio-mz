    ...
    return (
        ...
        <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            <nav class="flex flex-wrap justify-center -mx-5 -my-2">
                <div class="px-5 py-2">
                    <a href="#Imagegallery" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                        Work
                    </a>
                </div>
                <div class="px-5 py-2">
            ...
            <div class="flex justify-center mt-8 space-x-6">
                ...
                <a href="https://www.instagram.com/mrunmayzagadephotography/" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://www.instagram.com/mrunmayzagadephotography/" class="text-gray-400 hover:text-gray-500">
                    ...
                    <svg class="w-6 h-6"  aria-hidden="true" fill="currentColor" viewBox="0 0 16 16">
